...
const makeQAPrompt = (projectName, repositoryUrl, contentType, chatPrompt, targetAudience) => PromptTemplate.fromTemplate(`You are an AI assistant for a software project called ${projectName}. You are trained on all the ${contentType} that makes up this project.
...
Answer in Markdown:`);
export const makeChain = (projectName, repositoryUrl, contentType, chatPrompt, targetAudience, vectorstore, llms, onTokenStream) => {
    /**
     * GPT-4 or GPT-3
     */
