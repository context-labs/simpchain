...
import { printModelDetails, totalIndexCostEstimate, } from '../../utils/LLMUtil.js';
import chalk from 'chalk';
export const estimate = async ({ name, repositoryUrl, root, output, llms, ignore, filePrompt, folderPrompt, chatPrompt, contentType, targetAudience, linkHosted, }) => {
